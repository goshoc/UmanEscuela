...
$vSql = "SELECT * FROM personas where id_tipo_usuario=2";
...
*/
$vSql = "SELECT * FROM personas where id_tipo_usuario=2 limit $inicio,$Cant_por_Pag";
$vResultado = mysqli_query($con, $vSql) or die (mysqli_error($con));
?>

<table style= "margin-left: 15px; margin-top: 15px;" class="table-bordered table" border=1>
        <tr class="success">
          <td><b>Lista de usuarios</b></td>
        </tr>
