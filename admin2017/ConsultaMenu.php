...
$vSql = "SELECT descripcion FROM menu ";
...
*/
$vSql = "SELECT descripcion FROM menu limit $inicio,$Cant_por_Pag";
$vResultado = mysqli_query($con, $vSql) or die (mysqli_error($con));
?>

<table style= "margin-left: 15px; margin-top: 15px;" class="table-bordered table" border=1>
        <tr class="success">
          <td><b>Lista de Menús</b></td>
        </tr>
...
//si muestro el índice de la página actual, no coloco enlace
    echo "<strong>". $pagina . "</strong>";// else if ($pagina == $i)  echo  " - "."<a href='ConsultaMenu.php?pagina=" . $i ."'>" . $i . "</a>";
  else if ($total_paginas == $i) echo  " - "."<a href='ConsultaMenu.php?pagina=" . $i ."'>" . $i . "</a>" ;
//si la página no es la actual, coloco el enlace para ir a esa página

    else echo  " - "."<a href='ConsultaMenu.php?pagina=" . $i ."'>" . $i . "</a>". " - " ;}}?>
